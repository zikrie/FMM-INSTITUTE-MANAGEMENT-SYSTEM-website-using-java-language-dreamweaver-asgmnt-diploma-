...
if ($num > 0) {
header('Location: mainMenu_trainee.php');
}
else {
echo header('Location: mainMenu_trainee.php');
}
}
?>
 ...
 <html>
    <head>
    <title>Welcome to FMM Institute Management</title>
 ...
 <div align="center"><table>
            ...
            <div align="center">
              <p>Not a registered yet?<a href="trainee_reg2.php">Please register now.</a></p>
              <p> <a href="mukadepan.php"> <a href="loginpage.php">

...
if ($num > 0) {
header('Location: main_staf.php');
}
else {
echo header('Location: main_staf.php');
}
}
?>
 ...
 <html>
    ...
    <div style="margin:30px;">
    <div align="center">PLEASE ENTER YOUR LOGIN  DETAIL</div>
   
   <form  method="post" action=""><div align="center"><table>
            <td>&nbsp;</td>
   ...
   <p>&nbsp;</p>
   <p> <a href="loginpage.php"> <a href="loginpage.php">
